"""Factory functions for constructing CGCNN benchmark models."""
...
def get_config(cfg):
    ...
    config_params = {
        ...
        # },
        "model_params": {
            "orig_atom_fea_len": cfg.CGCNN.ORIG_ATOM_FEA_LEN,
            "nbr_fea_len": cfg.CGCNN.NBR_FEA_LEN,
            "atom_fea_len": cfg.CGCNN.ATOM_FEA_LEN,
            "pos_fea_len": cfg.CGCNN.POS_FEA_LEN,
